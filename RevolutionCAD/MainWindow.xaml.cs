...
namespace RevolutionCAD
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            MessageBox.Show("Революционная система автоматического проектирования\nРазработана в кооперации гигантов мысли, отцами русской демократии, студентами групп КС-16 и ПОВТ-16 ФКНТ ГОУВПО \"ДонНТУ\" 2020г.\nРуководитель проекта: Николаев Дмитрий\nВедущий разработчик: Стамбула Дмитрий\nДизайн страниц: Стамбула Дмитрий, Алутин Евгений\nВсе права защищены вахтёршой.", "Revolution CAD", MessageBoxButton.OK, MessageBoxImage.Information);
        }
